    ...
    <div class="sidebar">
        <nav class="nav1">
          <ul>
            ...
            <li><a href="admin-events.php"><i class="fas fa-calendar"></i><span>Events</span></a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div style="display:flex;justify-content:center">
                                ...
                                <h1 style="margin-left:1rem; margin-top:1.2rem"class="page-header">Booking Record</h1>
                            </div>
                            <hr>
                            <br>
